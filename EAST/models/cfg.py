...
max_train_img_size = 640#int(train_task_id[-3:])
max_predict_img_size = 640#int(train_task_id[-3:])  # 2400
...
origin_image_dir_name = 'train_dataset/'
origin_txt_dir_name = 'train_lable.csv'

origin_val_image_dir_name = 'verify_dataset/'
origin_val_txt_dir_name = 'verify_lable.csv'

origin_test_image_dir_name = 'test_dataset/'
origin_test_txt_dir_name = 'verify_lable.csv'

#======================================================================#

train_image_dir_name = 'images_train_%s/' % train_task_id
train_label_dir_name = 'labels_train_%s/' % train_task_id

val_image_dir_name = 'images_val_%s/' % train_task_id
val_label_dir_name = 'labels_val_%s/' % train_task_id
